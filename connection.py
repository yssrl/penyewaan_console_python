...
# mycursor.execute('CREATE TABLE transaksi (id INT AUTO_INCREMENT PRIMARY KEY, gameconsole_id VARCHAR(55), nama_penyewa VARCHAR(55), harga_sewa_per_hari INT, jumlah_hari INT)')