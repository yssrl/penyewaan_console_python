...
"")
        ...
        self.pushButton_9.clicked.connect(self.insert_sewa_consol)
        self.pushButton_7.clicked.connect(self.update_sewa_consol)
        self.pushButton_8.clicked.connect(self.delete_sewa_consol)
        self.pushButton_2.clicked.connect(self.select_sewa_consol)
    ...
    def insert_sewa_consol(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = isc.Ui_MainWindow()
        self.ui.setupUi(self.window)
        self.window.show()
        self.centralwidget.window().close()

    def update_sewa_consol(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = usc.Ui_MainWindow()
        self.ui.setupUi(self.window)
        self.window.show()
        self.centralwidget.window().close()

    def delete_sewa_consol(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = dsc.Ui_MainWindow()
        self.ui.setupUi(self.window)
        self.window.show()
        self.centralwidget.window().close()

    def select_sewa_consol(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = ssc.Ui_MainWindow()
        self.ui.setupUi(self.window)
        self.window.show()
        self.centralwidget.window().close()
